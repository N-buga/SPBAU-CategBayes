...
class CatboostEvaluation(object):
    ...
    def __init__(self,
        ...
        Args:
            ...
            :param seed: (int) The seed using in random for getting permutations for cross-validation.
    ...
    def _create_eval_feature_cases(params, set_features_to_eval, eval_type):
        ...
        baseline_case = ExecutionCase(params,
                                      ignored_features=list(set_features_to_eval))
        # test
    ...
    def eval_features(self,
        ...
        if "loss_function" in params and params["loss_function"] != objective_function:
            raise CatboostError("Loss function in params {} should be equal to feature evaluation objective "
                                "function {}".format(params["loss_function"], objective_function))
